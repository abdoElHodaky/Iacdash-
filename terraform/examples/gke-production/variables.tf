...
variable "private_endpoint" {
  description = "Whether to use private endpoint for the cluster"
  type        = bool
  default     = false
}
...
variable "use_gke_gateway_addon" {
  description = "Whether to use GKE Gateway addon"
  type        = bool
  default     = true
}
...
variable "install_monitoring" {
  description = "Whether to install monitoring stack (only if managed Prometheus is disabled)"
  type        = bool
  default     = false
}
